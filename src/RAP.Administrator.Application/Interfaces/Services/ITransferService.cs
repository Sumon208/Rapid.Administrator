...
namespace RAP.Administrator.Application.Interfaces.Services
{
    public interface ITransferService
    {
        ...
        Task<RequestResponse> CreateAsync(TransferEntity entity, int userId, string language);
        Task<RequestResponse> CreateBulkAsync(IEnumerable<TransferEntity> entities, int userId, string language);
        Task<RequestResponse> UpdateAsync(TransferEntity entity, int userId, string language);
        ...
        Task<RequestResponse> GetAllAuditsAsync(int transferId);
