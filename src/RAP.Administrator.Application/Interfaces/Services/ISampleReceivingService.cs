...
namespace RAP.Administrator.Application.Interfaces.Services
{
    public interface ISampleReceivingService
    {
        ...
        Task<RequestResponse> CreateAsync(SampleReceivingEntity entity, int userId, string language);
        Task<RequestResponse> CreateBulkAsync(IEnumerable<SampleReceivingEntity> entities, int userId, string language);
        Task<RequestResponse> UpdateAsync(SampleReceivingEntity entity, int userId, string language);
        ...
        Task<RequestResponse> GetAllAuditsAsync(int sampleRId);
